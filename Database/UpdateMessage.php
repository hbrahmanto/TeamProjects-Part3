<?php
//Updates a message on the database from a given user in a given chat
...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
	...
	$MessageID = cleanInput($array["MessageID"]); 	// expecting integer
...
if (validateData($UserID, $ChatID, $MessageID) == true) {	
	$conn = mysqli_connect("localhost","debian-sys-maint","IZqESYqnzEnILCP4","team001");
	$sql = "UPDATE ChatMessage SET MessageContents = ?, IsEdited = 1 WHERE MessageID = ?";
